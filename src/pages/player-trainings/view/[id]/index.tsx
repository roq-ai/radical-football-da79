...
import { getPlayerTrainingById } from 'apiSdk/player-trainings';
...
function PlayerTrainingViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Player Training Detail View
          </Text>
          {hasAccess('player_training', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/player-trainings/edit/${data?.id}`} passHref legacyBehavior>
              <Button
                ...
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/training-sessions/view/${data?.training_session?.id}`}>
                      {data?.training_session?.description}
                    </Link>
                  </Text>
                </Flex>
              )}
